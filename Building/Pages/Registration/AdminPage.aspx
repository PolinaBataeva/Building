<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Building.Pages.Registration.AdminPage" %>
      ...
      <asp:Table ID="Table1" runat="server" style="margin-left: 20px; margin-top:10px;">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:Image ID="Image1" ImageUrl="~/Images/12.jpg" Height="150px" runat="server" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Right">
